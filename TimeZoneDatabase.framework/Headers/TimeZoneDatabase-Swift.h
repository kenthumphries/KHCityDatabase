...
SWIFT_CLASS("_TtC16TimeZoneDatabase13CityLocations")
@interface CityLocations : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)appendLocations:(NSArray<Location *> * __nonnull)locations;
- (void)appendLocation:(Location * __nonnull)location;
@end


@interface CityLocations (SWIFT_EXTENSION(TimeZoneDatabase))
- (CityLocations * __nonnull)locationsMatchingCityNameEnglish:(NSString * __nonnull)cityNameEnglish;
@end
...
SWIFT_CLASS("_TtC16TimeZoneDatabase8Location")
@interface Location : RealmSwiftObject
@property (nonatomic, copy) NSString * __nonnull cityNameEnglish;
@property (nonatomic, copy) NSString * __nonnull timeZoneEnglish;
@property (nonatomic, copy) NSString * __nonnull countryCode;
@property (nonatomic, copy) NSString * __nonnull countryNameEnglish;
@property (nonatomic, copy) NSString * __nonnull admin1Code;
