...
class TimeZoneRealmCreator {
    ...
    func generatePopulatedRealmDatabase() throws -> String {
        ...
        let locations = try TimeZoneFileParser(citiesFileName: citiesFileName, admin1FileName: admin1FileName, inBundle: NSBundle.mainBundle()).parseLocations()
