...
SWIFT_MODULE_NAMESPACE_PUSH("KHCityDatabase")
@class RLMRealm;
@class RLMObjectSchema;
@class RLMSchema;

SWIFT_CLASS("_TtC14KHCityDatabase11BoundingBox")
@interface BoundingBox : RealmSwiftObject
@property (nonatomic, copy) NSString * _Nonnull locationIdentifier;
